...
console.log(`1. sort the array_employee in ascending order of emp_id:\n`);

arrayEmp.sort((id1,id2) =>{
    return id1.emp_id>id2.emp_id ? 1:-1;
});

arrayEmp.forEach((currentValue)=>{
    console.log(currentValue.emp_id,"  ",currentValue.emp_name,"  ",currentValue.emp_dept);
});

console.log(`2. Sort the array_employee in ascending order of emp_dept:\n`);

arrayEmp.sort((dept1,dept2) =>{
...
console.log(`3. Sort the array_employee in descending order of emp_salary:\n`);
arrayEmp.sort((sal1,sal2) =>{
